...
// Data transaksi dummy yang sama dengan seed.js
...
async function main() {
  console.log('🧹 Memulai pembersihan data dummy bawaan demo...');
  ...
  console.log(`✅ Pembersihan selesai! Berhasil menghapus ${deletedCount} transaksi dummy.`);
}

main()
  .catch(e => {
    console.error('❌ Terjadi kesalahan saat menghapus data dummy:', e.message);
    process.exit(1);
  })
